                ...
                <form id="msform" class="px-3">
                    <div class="d-flex justify-content-center align-items-center position-relative mb-5">
                        <div class="col text-center position-relative">
                            <div
                                class="circle-icon {{ Route::currentRouteName() == 'installs' ? 'active' : '' }} {{ Route::currentRouteName() == 'database_import' ? 'active' : '' }} {{ Route::currentRouteName() == 'profil_perusahaan' ? 'active' : '' }}{{ Route::currentRouteName() == 'feature_toggles' ? 'active' : '' }}{{ Route::currentRouteName() == 'finish' ? 'active' : '' }}">
                                <i class="bi bi-asterisk"></i>
                            </div>
                            <div class="step-label">Requirements & Permissions</div>
                        </div>
                        <hr
                            class="connector-line {{ Route::currentRouteName() == 'database_import' ? 'active' : '' }} {{ Route::currentRouteName() == 'profil_perusahaan' ? 'active' : '' }}{{ Route::currentRouteName() == 'feature_toggles' ? 'active' : '' }}{{ Route::currentRouteName() == 'finish' ? 'active' : '' }}" />
                        <div class="col text-center position-relative">
                            <div
                                class="circle-icon {{ Route::currentRouteName() == 'database_import' ? 'active' : '' }} {{ Route::currentRouteName() == 'profil_perusahaan' ? 'active' : '' }}{{ Route::currentRouteName() == 'feature_toggles' ? 'active' : '' }}{{ Route::currentRouteName() == 'finish' ? 'active' : '' }}">
                                <i class="bi bi-database"></i>
                            </div>
                            <div class="step-label">Database Import</div>
                        </div>
                        <hr
                            class="connector-line {{ Route::currentRouteName() == 'profil_perusahaan' ? 'active' : '' }}{{ Route::currentRouteName() == 'feature_toggles' ? 'active' : '' }}{{ Route::currentRouteName() == 'finish' ? 'active' : '' }}" />
                        <div class="col text-center position-relative">
                            <div
                                class="circle-icon {{ Route::currentRouteName() == 'profil_perusahaan' ? 'active' : '' }}{{ Route::currentRouteName() == 'feature_toggles' ? 'active' : '' }}{{ Route::currentRouteName() == 'finish' ? 'active' : '' }}">
