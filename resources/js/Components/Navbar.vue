...
<template>
    ...
    <nav class="w-full px-6 py-2 lg:px-16 bg-primary shadow-sm fixed top-0 left-0 z-50 font-custom">
        <div class="container mx-auto flex items-center justify-between py-2">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                <Link href="/" class="text-typography-dark hover:text-typography-hover2 transition font-semibold text-lg">Beranda
                </Link>

                <Link v-if="featureToggles.produk_module === 1" href="/produk"
                    class="text-typography-dark hover:text-typography-hover2 transition font-semibold text-lg">
                Produk
                </Link>
                ...
                <div class="relative cursor-pointer" @click="toggleMegaMenu">
                    <span
                        class="text-typography-dark hover:text-typography-hover2 transition font-semibold text-lg flex items-center">
                        Lainnya
    ...
    <Transition name="fade-slide">
        <div v-if="isMobileMenuOpen"
            ...
            <Link href="/" class="text-base py-1">Beranda</Link>
            <Link v-if="featureToggles.produk_module === 1" href="/produk" class="text-base py-1">Produk</Link>
            <Link v-if="featureToggles.feedback_module === 1" href="/feedback" class="text-base py-1">Feedback</Link>

            <div class="text-base py-1 flex justify-between items-center cursor-pointer" @click="toggleMegaMenu">
                <span>Lainnya</span>
