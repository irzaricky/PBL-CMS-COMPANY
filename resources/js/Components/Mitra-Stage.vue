            ...
            <div class="w-full max-w-5xl mx-auto px-4 md:px-6 py-24">
              ...
              ul.nextSibling.setAttribute('aria-hidden', 'true');
                        ...
                        <ul x-ref="logos"
                            ...
                            <li><img src="image/disney.svg" alt="Disney" /></li>
                            <li><img src="image/airbnb.svg" alt="Airbnb" /></li>
                            <li><img src="image/apple.svg" alt="Apple" /></li>
                            <li><img src="image/spark.svg" alt="Spark" /></li>
                            <li><img src="image/samsung.svg" alt="Samsung" /></li>
                            <li><img src="image/quora.svg" alt="Quora" /></li>
                            <li><img src="image/sass.svg" alt="Sass" /></li>
                        </ul>
                    </div>
...
<script setup>
// Tidak perlu logic tambahan di script setup karena semua interaktivitas ditangani oleh Alpine.js
</script>
