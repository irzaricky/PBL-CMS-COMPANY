...
<template>
    <div class="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-lg z-50 p-4 font-custom">
        <div class="mb-4">
            <p class="text-xs text-gray-500">{{ greeting }},</p>
            <p class="text-base font-semibold text-gray-800">{{ user?.name ?? 'Pengguna' }}</p>
        </div>
