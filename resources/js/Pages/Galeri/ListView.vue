            ...
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-28">
                <div class="flex flex-col gap-20">
                    ...
                    <div class="text-center">
                        ...
                        <!-- Search form -->
                        <div
                            class="w-full max-w-2xl mx-auto flex flex-col items-center gap-4"
                        >
                            <div
                            ...
                            >
                                ...
                                />
                                <button
                                    @click="fetchGaleries(searchQuery)"
                            ...
                            <p
                                class="text-xs font-normal font-custom leading-none"
                            >
                    ...
                    >
                        <div
                            class="flex gap-2 font-custom text-sm whitespace-nowrap"
                        >
                            <!-- Skeleton Kategori -->
                    ...
                    <div class="flex flex-col divide-y divide-white/20">
                        ...
                        >
                            ...
                            >
                                <div class="max-w-xl">
                                    <div
                                        class="h-8 w-2/3 bg-white/30 animate-pulse rounded-md mb-4"
                                    ></div>
                                    <div
                                        class="h-4 w-full bg-white/20 animate-pulse rounded-md mb-2"
                                    ></div>
                                    <div
                                        class="h-4 w-4/5 bg-white/20 animate-pulse rounded-md mb-2"
                                    ></div>
                                    <div
                                        class="h-4 w-3/4 bg-white/20 animate-pulse rounded-md mb-4"
                                    ></div>
                                    <div
                                        class="h-8 w-32 bg-white/30 animate-pulse rounded-full mt-4"
                                    ></div>
                                </div>
                            </div>
                            ...
                            <div class="lg:w-1/2 flex flex-col gap-6 w-full">
                                <div
                                    class="aspect-video w-full overflow-hidden rounded-2xl bg-white/20 animate-pulse"
                                ></div>
                                <div class="flex justify-between items-center">
                                    <div class="flex gap-4">
                                        <div
                                            class="w-12 h-12 rounded-full bg-white/30 animate-pulse"
                                        ></div>
                                        <div
                                            class="w-12 h-12 rounded-full bg-white/30 animate-pulse"
                                        ></div>
                    ...
                    <!-- Pagination -->
                    <div
                        v-if="!loadingGaleries && lastPage > 1"
                    ...
                    >
                        ...
                        <!-- Indikator halaman -->
                        <div
                            class="px-4 py-2 rounded-xl border border-white text-white font-semibold"
                        >
