...
function prevImage(id) {
    ...
    const total = galeries.value.find(g => g.id_galeri === id)?.thumbnail_galeri.length || 0;
            ...
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-28">
                <div class="flex flex-col gap-20">
                    <div class="text-center">
                        ...
                        <p class="text-lg text-secondary/80 mt-2">Kumpulan dokumentasi visual dalam bentuk galeri.</p>
                    </div>

                    <!-- List Galeri -->
                    <div v-if="!loading" class="flex flex-col divide-y divide-white/20">
                        <div v-for="(galeri, index) in galeries" :key="galeri.id_galeri"
                            ...
                            <div class="lg:w-1/2 flex flex-col justify-center h-full">
                                <div class="max-w-xl">
                                    <h3 class="text-2xl lg:text-3xl font-normal pb-2">
                                        {{ galeri.judul_galeri }}
                                    </h3>
                            ...
                            <div class="lg:w-1/2 flex flex-col gap-6 w-full">
                                ...
                                <div class="aspect-video w-full overflow-hidden rounded-2xl bg-gray-200">
                                    <img v-if="galeri.thumbnail_galeri.length"
                                        ...
                                        class="w-full h-full object-cover" alt="Galeri Image" />
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex gap-2">
                                        <span v-for="(img, index) in galeri.thumbnail_galeri" :key="index" :class="[
                                            'w-2 h-2 rounded-full transition-all',
                                            index === activeSlideIndex[galeri.id_galeri]
                                                ? 'bg-white'
                                                : 'bg-white/30'
                                        ]"></span>
                                    </div>
