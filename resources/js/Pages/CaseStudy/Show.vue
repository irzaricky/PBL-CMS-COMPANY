    ...
    <AppLayout>
        ...
        >
            ...
            <div v-else-if="caseStudy" class="flex flex-col gap-16">
                ...
                <div class="flex flex-col gap-8">
                    <div class="relative">
                        <img
                            ...
                            :src="getImageUrl(caseStudy.thumbnail_case_study)"
                            :alt="caseStudy.judul_case_study"
                        />
                    </div>

                    <!-- Info Mitra - Enhanced Layout -->
                    <div
                        class="bg-gradient-to-r from-secondary/5 via-white to-secondary/5 rounded-2xl border-2 border-secondary/20 overflow-hidden"
                    >
                        <!-- Header dengan Background -->
                        <div
                            class="bg-secondary/10 px-6 py-4 border-b border-secondary/20"
                        >
                            <h3
                                class="text-lg font-semibold text-secondary uppercase tracking-wider"
                            >
                                Klien & Mitra
                            </h3>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-6 mb-6">
                                <div class="relative">
                                    ...
                                    >
                                        {{
                                            caseStudy.mitra?.nama_mitra?.charAt(
                                                0
                                            ) || "M"
                                        }}
                                    </div>
                            ...
                            <div
                                v-if="caseStudy.mitra?.deskripsi"
                                class="mb-6 p-4 bg-gray-50 rounded-lg"
                            >
                                <p class="text-gray-700 leading-relaxed">
                                    {{ caseStudy.mitra.deskripsi }}
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <div class="flex gap-3">
                                    <button
                                        class="flex items-center gap-2 px-4 py-2 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 hover:border-secondary/50 transition-all duration-200 text-sm font-medium"
                                        @click="copyLink"
                                    >
                                        <Copy class="w-4 h-4" />
                ...
                <!-- Deskripsi Singkat -->
                <div
                    class="bg-gray-50 p-6 rounded-xl border-l-4 border-secondary"
                >
                    <h2 class="text-xl font-semibold mb-3">
                        Ringkasan Studi Kasus
                    </h2>
                    <p class="text-gray-700 leading-relaxed">
                        {{ caseStudy.deskripsi_case_study }}
                    </p>
                </div>
                ...
                <div
                    ...
                    v-html="caseStudy.isi_case_study"
                ></div>
            ...
            >
                ...
                <p class="text-gray-600">
                    Studi kasus yang Anda cari tidak ditemukan atau terjadi
                    kesalahan.
                </p>
                <Link
                    href="/studi-kasus"
