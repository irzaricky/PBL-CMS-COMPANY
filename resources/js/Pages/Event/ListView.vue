...
import { MapPin, Clock, Search } from "lucide-vue-next";
    ...
    <AppLayout>
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-16 py-28 bg-background text-black font-custom">
            <div class="flex flex-col gap-20 overflow-hidden">
                    ...
                    <div class="flex flex-col lg:flex-row gap-12">
                        ...
                        <div class="relative flex-1 animate-pulse">
                            ...
                            <div
                                ...
                                <div class="w-8 h-4 bg-gray-200 mb-1"></div>
                                <div class="w-10 h-8 bg-gray-200 mb-1"></div>
                ...
                <div v-if="loading" class="flex flex-col gap-10">
                    <div class="flex flex-wrap justify-between items-center gap-4">
                        ...
                        <div class="w-full md:w-auto md:max-w-md">
                            <div class="relative">
                                <div class="h-10 bg-gray-200 rounded-full w-64 animate-pulse"></div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col divide-y divide-gray-200">
                        <!-- Skeleton items -->
                        <div v-for="i in 3" :key="i" class="flex flex-col lg:flex-row gap-8 py-8 animate-pulse">
                            <div class="relative w-full h-72 lg:w-64 lg:h-48 flex-shrink-0 bg-gray-200 rounded-2xl">
                                <div class="absolute left-4 top-4 bg-white rounded-2xl p-2 w-16 h-20"></div>
                            </div>
                ...
                <!-- No events found -->
                <div v-else-if="events.length === 0 && !loading" class="flex flex-col gap-10">
                    <div class="flex flex-wrap justify-between items-center gap-4">
                        <h2 class="text-4xl font-normal">Event Lainnya</h2>
                        <div class="w-full md:w-auto md:max-w-md">
                            <div class="relative">
                                <input v-model="searchQuery" @input="handleSearch" type="text" placeholder="Cari event..."
                                    class="w-full px-5 py-3 pr-12 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent shadow-sm" />
                                <div class="absolute right-3 top-1/2 transform -translate-y-1/2">
                                    <button @click="fetchEvents" class="p-1 rounded-full hover:bg-gray-100">
                    ...
                    <div class="flex flex-col items-center justify-center gap-6 py-20 text-center">
                        <div class="flex flex-col lg:flex-row items-center gap-6 text-left">
                            ...
                            <div>
                                <h3 class="text-xl md:text-2xl font-semibold text-gray-700 font-custom">Belum ada event
                                    lainnya</h3>
                                <p class="text-sm md:text-base text-gray-500 font-custom">Silakan periksa kembali nanti
                                    atau coba kata kunci lain.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-else-if="events.length" class="flex flex-col gap-10">
                    <div class="flex flex-wrap justify-between items-center gap-4">
                        <h2 class="text-4xl font-normal">Event Lainnya</h2>
                        <div class="w-full md:w-auto md:max-w-md">
                            <div class="relative">
