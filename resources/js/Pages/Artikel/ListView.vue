    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-custom">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            ...
            <div class="w-full md:w-1/3 relative">
                <input v-model="searchQuery" type="text" placeholder="Search articles..." @input="handleSearch"
        ...
        <div class="mb-6">
            <div class="flex flex-wrap gap-2">
                <button @click="filterByCategory(null)" class="px-3 py-1 rounded-full text-sm font-medium" :class="selectedCategory === null
                        ? 'bg-blue-600 text-white'
                        : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                    ">
                    Semua
                </button>
                <button v-for="category in categories" :key="category.id_kategori_artikel"
                    @click="filterByCategory(category.id_kategori_artikel)"
                    class="px-3 py-1 rounded-full text-sm font-medium" :class="selectedCategory === category.id_kategori_artikel
                            ? 'bg-blue-600 text-white'
                            : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                        ">
