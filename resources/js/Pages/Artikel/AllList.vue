...
<template>
    <div
        class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-6 py-20 font-custom text-black"
    >
        <div class="flex flex-col lg:grid lg:grid-cols-4 gap-10">
            ...
            <aside
                class="order-2 lg:order-1 lg:col-span-1 w-full flex flex-col gap-6"
            >
                <div class="relative w-full">
                    ...
                    <input
                        ...
                        class="w-full px-10 py-2 border rounded-lg"
                    />
                </div>
                <div class="flex flex-col gap-2">
                    <button
                        :class="[
                            'text-left px-4 py-2 rounded-xl border',
            ...
            <!-- Daftar Artikel -->
            <div class="order-3 lg:order-2 lg:col-span-3 flex flex-col gap-6">
                <!-- Skeleton -->
                <div
                    v-if="loading"
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <h3 class="text-2xl leading-snug">
                                    {{ post.judul_artikel }}
                                </h3>
                            </a>
                            ...
                            <div class="flex items-center gap-4 mt-2">
                                <img
                                    ...
                                    :src="
                                        getImageUrl(post.user.foto_profil, true)
                                    "
                                    alt="Foto profil"
                                />
                                <div class="flex flex-col">
                                    ...
                                    >
                                        ...
                                        <span
                                            class="text-xs font-normal leading-loose py-1"
                                            >•</span
                                        >
                                        <span>{{
                                            new Date(
