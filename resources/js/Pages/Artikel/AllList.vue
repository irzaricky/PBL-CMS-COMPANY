        ...
        <div class="flex flex-col lg:grid lg:grid-cols-4 gap-10">
            ...
            <div class="order-1 lg:order-1 lg:col-span-4">
                ...
                <p class="text-lg font-normal leading-relaxed">
                    Temukan berbagai artikel menarik yang membahas topik-topik terkini, tips, dan wawasan dari
                    berbagai bidang. Jelajahi pengetahuan baru dan inspirasi dari tulisan-tulisan kami.
                </p>
            </div>

            <!-- Sidebar: Search & Kategori -->
            <aside class="order-2 lg:order-1 lg:col-span-1 w-full flex flex-col gap-6">
