...
async function fetchTestimoni() {
    ...
    try {
        const response = await axios.get(`/api/testimoni/artikel/${article.value.id_artikel}`);
            ...
            <div v-if="loading" class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="flex-1 flex flex-col gap-10">
                    ...
                    <div class="flex flex-col gap-8">
                        <div class="bg-gray-200 h-[300px] sm:h-[400px] lg:h-[600px] rounded-2xl w-full animate-pulse">
                        </div>
                ...
                <div class="w-full lg:w-80 flex-shrink-0">
                    ...
                    <div class="flex flex-col gap-4">
                        <div v-for="i in 4" :key="i"
                            ...
                            <div class="bg-gray-200 w-16 h-16 rounded flex-shrink-0 animate-pulse"></div>
                            <div class="flex-1">
                                <div class="bg-gray-200 h-4 w-full rounded animate-pulse mb-2"></div>
                                <div class="bg-gray-200 h-4 w-5/6 rounded animate-pulse"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div v-else class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="flex-1 flex flex-col gap-10">
                    ...
                    <div class="flex flex-col gap-12">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <h1 class="text-4xl sm:text-5xl font-normal leading-tight">
                                {{ article?.judul_artikel || 'Artikel tidak ditemukan' }}
                            </h1>
                        </div>
                    </div>
                            ...
                            <div class="bg-gray-50 rounded-xl w-full p-6 border border-gray-100">
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                    <div class="flex items-center gap-2 text-gray-600">
                                        <Eye class="w-4 h-4" />
                                        <span class="text-sm font-medium">{{ article?.jumlah_view || 0 }}×
                                            dilihat</span>
                                    </div>
                    ...
                    <div v-if="testimoniList.length" class="w-full mt-16 border-t pt-10">
                        ...
                        <h2 class="text-2xl font-semibold mb-4">{{ article?.judul_artikel }}</h2>
                        <div class="space-y-6">
                            <div v-for="testimoni in testimoniList" :key="testimoni.id_testimoni_artikel"
                                ...
                                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2 gap-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-gray-800">{{ testimoni.user?.name || 'Anonim' }}
                                            </p>
                    ...
                    <div v-if="isLoggedIn && article" class="w-full mt-10">
                        <span class="text-sm text-gray-500">Sudah membaca artikel ini?</span>
                        <h2 class="text-xl font-semibold mb-3">Berikan ulasanmu</h2>
                    ...
                    <!-- LOGIN WARNING -->
                    <div v-else-if="!isLoggedIn && article"
                        ...
                        <div class="text-sm leading-relaxed">
                            ...
                            <p class="italic text-gray-600">Login terlebih dahulu untuk menulis testimoni dan berbagi
                                pendapatmu tentang artikel ini.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div v-for="item in relatedArticles" :key="item.id_artikel"
                            ...
                            <div class="flex flex-col justify-center">
                                <h3 class="font-semibold text-lg lg:text-sm leading-snug line-clamp-2 pb-1">
                                    {{ item.judul_artikel }}
                                </h3>
                                <p class="text-sm lg:text-xs text-gray-500 line-clamp-2">
